#!/usr/bin/env python3
"""Generate the CV Preprints and Publications sections from publications.bib."""
...
DEFAULT_OUTPUT = Path("cv/generated/publications.tex")
...
def render_publications_file(
    ...
    lines = [
        ...
        "% Do not edit this file manually; update publications.bib and rerun the generator.",
    ]
